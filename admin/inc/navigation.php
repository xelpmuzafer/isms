...
<aside class="main-sidebar sidebar-light-teal navbar-light elevation-4 sidebar-no-expand">
    <!-- Brand Logo -->
    <a href="https://uat.reverely.ai/redirect-to-landing-page" class="brand-link bg-primus text-sm">
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child"
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview" style="display: none;">
                                    <li class="nav-item">
                                        <a href="./?page=reports/stockin"
                                            class="nav-link tree-item nav-reports_stockin">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Monthly Stock-In Report</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="./?page=reports/stockout"
                                            class="nav-link tree-item nav-reports_stockout">
                                            <i class="far fa-circle nav-icon"></i>
