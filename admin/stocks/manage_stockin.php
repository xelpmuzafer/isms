...
<div class="container-fluid">
    <form action="" id="stockin-form">
        ...
        <?php
        $qry1 = $conn->query("SELECT rate_per_unit from `item_list` where id = '{$_GET['iid']}' ");
        if ($qry1->num_rows > 0) {
        ...
        <div class="form-group">
            ...
            <input type="number" step="any" name="rate" id="rate" class="form-control form-control-sm rounded-0 text-right" value="<?= isset($rate) ? format_num($rate) : '' ?>" required>
        </div>
